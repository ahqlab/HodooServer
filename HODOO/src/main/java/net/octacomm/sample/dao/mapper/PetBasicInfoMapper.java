...
public interface PetBasicInfoMapper extends CRUDMapper<PetBasicInfo, DefaultParam, Integer> {
	...
	public String UPDATE_VALUES = " profileFilePath = #{profileFilePath} , profileFileName = #{profileFileName} , petName = #{petName} , sex = #{sex} ,petBreed = #{petBreed} , birthday = #{birthday} , neutralization = #{neutralization} , createDate = now(), petType = #{petType } ";
