...
*/
	...
	@Select("select pet.*, pet_basic_info.*, pet_chronic_disease.*, pet_physical_info.id, pet_physical_info.weight as physicalWeight, pet_weight_info.*, pet_user_selection_question.* from pet " + 
